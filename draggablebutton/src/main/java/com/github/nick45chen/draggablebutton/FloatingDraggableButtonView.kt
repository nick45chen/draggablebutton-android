...
class FloatingDraggableButtonView(
    ...
    private val buttonView: ImageView
                ...
                MotionEvent.ACTION_MOVE -> {
                    if (configuration.isDraggable) {
                        ...
                        if (isDragging) {
                            ...
                            val constrainedX = newX.coerceIn(0f, (parentView.width - view.width).toFloat())
                            val constrainedY = newY.coerceIn(0f, (parentView.height - view.height).toFloat())
    ...
    override fun show() {
        if (!isVisible) {
            ...
            buttonView.x = parentView.width - configuration.buttonSize - configuration.marginFromEdge.toFloat()
